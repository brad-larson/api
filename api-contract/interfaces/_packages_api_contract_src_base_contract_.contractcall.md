...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/bbc30ec9dc/packages/api-contract/src/base/Contract.ts#L25)*
