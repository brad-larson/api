...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/539a8c4cb5/packages/api-contract/src/base/Contract.ts#L25)*
