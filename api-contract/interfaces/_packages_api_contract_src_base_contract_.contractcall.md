...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/b26c7f9f0a/packages/api-contract/src/base/Contract.ts#L25)*
