...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/e9489d41cb/packages/api-contract/src/base/Contract.ts#L25)*
