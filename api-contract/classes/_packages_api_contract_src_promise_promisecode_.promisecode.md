...
*Defined in [packages/api-contract/src/promise/PromiseCode.ts:13](https://github.com/polkadot-js/api/blob/023c7588e5/packages/api-contract/src/promise/PromiseCode.ts#L13)*
