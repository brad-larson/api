...
*Defined in [packages/api-contract/src/rx/RxContract.ts:14](https://github.com/polkadot-js/api/blob/afa0e63ae8/packages/api-contract/src/rx/RxContract.ts#L14)*
