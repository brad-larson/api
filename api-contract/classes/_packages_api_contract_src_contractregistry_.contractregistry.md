...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/eed5e23e65/packages/api-contract/src/MetaRegistry.ts#L107)*
