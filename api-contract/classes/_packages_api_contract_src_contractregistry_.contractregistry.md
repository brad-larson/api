...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/afa0e63ae8/packages/api-contract/src/MetaRegistry.ts#L107)*
