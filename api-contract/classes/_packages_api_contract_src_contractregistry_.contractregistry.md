...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/bbc30ec9dc/packages/api-contract/src/MetaRegistry.ts#L107)*
