...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/023c7588e5/packages/api-contract/src/MetaRegistry.ts#L107)*
