...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/b26c7f9f0a/packages/api-contract/src/MetaRegistry.ts#L107)*
