...
*Defined in [packages/api-contract/src/rx/RxBlueprint.ts:14](https://github.com/polkadot-js/api/blob/539a8c4cb5/packages/api-contract/src/rx/RxBlueprint.ts#L14)*
