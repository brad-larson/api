...
\+ **new Tuple**(`registry`: [Registry](../interfaces/_types_registry_.registry.md), `Types`: TupleTypes, `value?`: AnyTuple): *[Tuple](_codec_tuple_.tuple.md)*

*Overrides void*

*Defined in [packages/types/src/codec/Tuple.ts:56](https://github.com/polkadot-js/api/blob/f1ebcddec6/packages/types/src/codec/Tuple.ts#L56)*
