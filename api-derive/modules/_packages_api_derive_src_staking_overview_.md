...
*Defined in [packages/api-derive/src/staking/overview.ts:16](https://github.com/polkadot-js/api/blob/1922676bd7/packages/api-derive/src/staking/overview.ts#L16)*
