...
*Defined in [packages/api-derive/src/staking/electedInfo.ts:13](https://github.com/polkadot-js/api/blob/b26c7f9f0a/packages/api-derive/src/staking/electedInfo.ts#L13)*
