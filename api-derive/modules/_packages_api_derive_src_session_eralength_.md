...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/afa0e63ae8/packages/api-derive/src/session/eraLength.ts#L13)*
