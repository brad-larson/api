...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/8b492021af/packages/api-derive/src/session/eraLength.ts#L13)*
