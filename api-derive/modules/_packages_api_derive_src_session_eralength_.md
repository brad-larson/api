...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/b26c7f9f0a/packages/api-derive/src/session/eraLength.ts#L13)*
