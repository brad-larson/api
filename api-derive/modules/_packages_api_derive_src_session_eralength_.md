...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/539a8c4cb5/packages/api-derive/src/session/eraLength.ts#L13)*
