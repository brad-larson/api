...
*Defined in [packages/api-derive/src/chain/bestNumberFinalized.ts:26](https://github.com/polkadot-js/api/blob/b26c7f9f0a/packages/api-derive/src/chain/bestNumberFinalized.ts#L26)*
