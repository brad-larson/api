...
*Defined in [packages/api-derive/src/contracts/fees.ts:48](https://github.com/polkadot-js/api/blob/36232c0289/packages/api-derive/src/contracts/fees.ts#L48)*
