...
*Defined in [packages/api-derive/src/contracts/fees.ts:48](https://github.com/polkadot-js/api/blob/2395401a2b/packages/api-derive/src/contracts/fees.ts#L48)*
