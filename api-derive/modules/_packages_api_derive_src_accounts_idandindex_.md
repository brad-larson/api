...
*Defined in [packages/api-derive/src/accounts/idAndIndex.ts:54](https://github.com/polkadot-js/api/blob/36232c0289/packages/api-derive/src/accounts/idAndIndex.ts#L54)*
