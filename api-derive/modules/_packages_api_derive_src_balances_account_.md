...
*Defined in [packages/api-derive/src/balances/account.ts:83](https://github.com/polkadot-js/api/blob/2395401a2b/packages/api-derive/src/balances/account.ts#L83)*
