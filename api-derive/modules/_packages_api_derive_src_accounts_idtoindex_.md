...
*Defined in [packages/api-derive/src/accounts/idToIndex.ts:28](https://github.com/polkadot-js/api/blob/b26c7f9f0a/packages/api-derive/src/accounts/idToIndex.ts#L28)*
