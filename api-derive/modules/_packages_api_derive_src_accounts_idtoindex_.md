...
*Defined in [packages/api-derive/src/accounts/idToIndex.ts:28](https://github.com/polkadot-js/api/blob/36232c0289/packages/api-derive/src/accounts/idToIndex.ts#L28)*
