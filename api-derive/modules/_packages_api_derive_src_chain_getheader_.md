...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/8b492021af/packages/api-derive/src/chain/getHeader.ts#L27)*
