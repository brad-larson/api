...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/023c7588e5/packages/api-derive/src/chain/getHeader.ts#L27)*
