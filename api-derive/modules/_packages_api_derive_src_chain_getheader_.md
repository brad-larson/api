...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/b26c7f9f0a/packages/api-derive/src/chain/getHeader.ts#L27)*
