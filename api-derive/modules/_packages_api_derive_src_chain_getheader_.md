...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/36232c0289/packages/api-derive/src/chain/getHeader.ts#L27)*
