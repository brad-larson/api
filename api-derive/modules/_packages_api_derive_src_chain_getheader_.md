...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/1922676bd7/packages/api-derive/src/chain/getHeader.ts#L27)*
