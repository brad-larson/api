...
*Defined in [packages/api-derive/src/chain/subscribeNewHeads.ts:26](https://github.com/polkadot-js/api/blob/b26c7f9f0a/packages/api-derive/src/chain/subscribeNewHeads.ts#L26)*
