...
*Defined in [packages/api-derive/src/elections/info.ts:57](https://github.com/polkadot-js/api/blob/36232c0289/packages/api-derive/src/elections/info.ts#L57)*
