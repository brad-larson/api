...
*Defined in [packages/api-derive/src/elections/info.ts:57](https://github.com/polkadot-js/api/blob/b26c7f9f0a/packages/api-derive/src/elections/info.ts#L57)*
