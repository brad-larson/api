...
*Defined in [packages/api-derive/src/chain/bestNumberLag.ts:26](https://github.com/polkadot-js/api/blob/2395401a2b/packages/api-derive/src/chain/bestNumberLag.ts#L26)*
