...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/539a8c4cb5/packages/api-derive/src/chain/bestNumber.ts#L25)*
