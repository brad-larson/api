...
*Defined in [packages/api-derive/src/collective/proposals.ts:32](https://github.com/polkadot-js/api/blob/66884febea/packages/api-derive/src/collective/proposals.ts#L32)*
