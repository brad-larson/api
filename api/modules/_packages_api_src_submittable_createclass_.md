...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/1922676bd7/packages/api/src/submittable/createClass.ts#L26)*
