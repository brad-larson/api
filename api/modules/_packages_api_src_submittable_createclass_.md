...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/28631f7180/packages/api/src/submittable/createClass.ts#L26)*
