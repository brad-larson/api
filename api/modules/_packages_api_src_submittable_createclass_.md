...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/afa0e63ae8/packages/api/src/submittable/createClass.ts#L26)*
