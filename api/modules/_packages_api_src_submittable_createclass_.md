...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/bbc30ec9dc/packages/api/src/submittable/createClass.ts#L26)*
