...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/539a8c4cb5/packages/api/src/submittable/createClass.ts#L26)*
