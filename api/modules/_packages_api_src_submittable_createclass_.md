...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/36232c0289/packages/api/src/submittable/createClass.ts#L26)*
