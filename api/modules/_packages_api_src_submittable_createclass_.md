...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/b26c7f9f0a/packages/api/src/submittable/createClass.ts#L26)*
