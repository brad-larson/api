...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/66884febea/packages/api/src/submittable/createClass.ts#L26)*
