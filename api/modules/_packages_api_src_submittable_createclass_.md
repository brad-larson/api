...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/8b492021af/packages/api/src/submittable/createClass.ts#L26)*
