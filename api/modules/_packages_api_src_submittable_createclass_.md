...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/2395401a2b/packages/api/src/submittable/createClass.ts#L26)*
