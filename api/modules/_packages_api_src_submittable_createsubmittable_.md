...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/bbc30ec9dc/packages/api/src/submittable/createSubmittable.ts#L17)*
