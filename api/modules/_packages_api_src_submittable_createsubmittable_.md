...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/b26c7f9f0a/packages/api/src/submittable/createSubmittable.ts#L17)*
