...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/2395401a2b/packages/api/src/submittable/createSubmittable.ts#L17)*
