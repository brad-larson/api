...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/023c7588e5/packages/api/src/submittable/createSubmittable.ts#L17)*
