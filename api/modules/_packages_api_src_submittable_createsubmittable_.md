...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/0327aedf8e/packages/api/src/submittable/createSubmittable.ts#L17)*
