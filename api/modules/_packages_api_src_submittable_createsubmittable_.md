...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/539a8c4cb5/packages/api/src/submittable/createSubmittable.ts#L17)*
